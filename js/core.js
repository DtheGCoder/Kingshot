...
KS.U = {
  ...
  fmt(n) {
    ...
    // Darüber hinaus: Zehnerpotenz, damit nie „Infinity" oder Kauderwelsch steht
    return (n / 1e18).toFixed(2).replace(/\.?0+$/, '') + 'Qi';
  },
